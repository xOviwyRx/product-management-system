...
?>
        ...
        <button class="mr-5 btn btn-outline-dark" 
                ...
                onclick="window.location.href='/addProduct/'"> ADD
        </button>
        <button class="mr-4 btn btn-outline-dark" form = "list_form"
                type="submit" name="delete" id="delete-product-btn">MASS DELETE
        </button>
    </div>
</div>
<hr>
