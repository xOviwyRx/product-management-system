...
<button class="mr-4 btn btn-outline-dark" form="list_form" type="submit" name="delete" id="delete-product-btn">MASS DELETE
</button>
</div>
</div>
<hr>
            ...
            ?>
                <label for="product<?= "{$i}_input_checkbox" ?>">
                    <div class="mr-5 mt-3 border border-dark mb-4 p-3 pb-5 product-box">
                        <input name="checked_products[]" type="checkbox" class="delete-checkbox" value="<?= $product->getProductId() ?>" id="product<?= "{$i}_input_checkbox" ?>" />
